...
use Generator;
use BC\WP\View\SupportContracts\Support\CanBeEscapedWhenCastToString;
use BC\WP\View\Support\Traits\EnumeratesValues;
use BC\WP\View\Support\Traits\Macroable;
 ...
 * @template TValue
 *
 * @implements \BC\WP\View\Support\Enumerable<TKey, TValue>
 */
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \BC\WP\View\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $source
     * @return void
     */
     ...
     * @template TMakeValue
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $items
     ...
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \BC\WP\View\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
     ...
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \BC\WP\View\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \BC\WP\View\Support\ItemNotFoundException
     * @throws \BC\WP\View\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \BC\WP\View\SupportContracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
